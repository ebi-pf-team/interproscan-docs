...
::
    ...
    # Must return *interproscan-5.78-109.0-64-bit.tar.gz: OK*
...
::
    ...
    tar -pxvzf interproscan-5.78-109.0-*-bit.tar.gz
...
Index hmm models
~~~~~~~~~~~~~~~~~~~~~~~~~
The compressed file contains the hmm models already indexed and ready to be used..
If for some reason you need to reindex the hmm models, you should run the command:
::
