...
Version 5.62-94.0 of the lookup service is only compatible with version
5.62-94.0 of InterProScan. Instructions below are for installing the
...
::
    ...
    wget https://ftp.ebi.ac.uk/pub/software/unix/iprscan/5/5.62-94.0/lookup_service_5.62-94.0.tar.gz
    wget https://ftp.ebi.ac.uk/pub/software/unix/iprscan/5/5.62-94.0/lookup_service_5.62-94.0.tar.gz.md5

    # Recommended checksum to confirm the download was successful:
    md5sum -c lookup_service_5.62-94.0.tar.gz.md5
    # Must return *lookup_service_5.62-94.0.tar.gz: OK*
...
::
    ...
    tar -pxvzf lookup_service_5.62-94.0.tar.gz
...
::
    ...
    cd lookup_service_5.62-94.0
    java -Xmx8000m -jar server-5.62-94.0-jetty-console.war
...
::
    ...
    cd lookup_service_5.62-94.0
    java -Xmx8000m -jar server-5.62-94.0-jetty-console.war  [--option=value] [--option=value]

    # Example command:
    # java -Xmx8000m -jar server-5.62-94.0-jetty-console.war --headless --port 8080
...
::
    ...
    $ java -Xmx8000m -jar server-5.62-94.0-jetty-console.war
    10242 [Thread-2] INFO org.simplericity.jettyconsole.DefaultJettyManager - Added web application on path / from war /example/path/to/server-5.62-94.0-jetty-console.war
