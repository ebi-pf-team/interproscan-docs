...
Version 5.64-96.0 of the lookup service is only compatible with version
5.64-96.0 of InterProScan. Instructions below are for installing the
...
::
    ...
    wget https://ftp.ebi.ac.uk/pub/software/unix/iprscan/5/5.64-96.0/lookup_service_5.64-96.0.tar.gz
    wget https://ftp.ebi.ac.uk/pub/software/unix/iprscan/5/5.64-96.0/lookup_service_5.64-96.0.tar.gz.md5

    # Recommended checksum to confirm the download was successful:
    md5sum -c lookup_service_5.64-96.0.tar.gz.md5
    # Must return *lookup_service_5.64-96.0.tar.gz: OK*
    # If not - try downloading the file again as it may be a corrupted copy.

(Direct link:
https://ftp.ebi.ac.uk/pub/software/unix/iprscan/5/5.64-96.0/lookup_service_5.64-96.0.tar.gz)

Extract the tarball:

::

    tar -pxvzf lookup_service_5.64-96.0.tar.gz
...
::
    ...
    cd lookup_service_5.64-96.0
    java -Xmx8000m -jar server-5.64-96.0-jetty-console.war
...
::
    ...
    cd lookup_service_5.64-96.0
    java -Xmx8000m -jar server-5.64-96.0-jetty-console.war  [--option=value] [--option=value]

    # Example command:
    # java -Xmx8000m -jar server-5.64-96.0-jetty-console.war --headless --port 8080
...
::
    ...
    $ java -Xmx8000m -jar server-5.64-96.0-jetty-console.war
    10242 [Thread-2] INFO org.simplericity.jettyconsole.DefaultJettyManager - Added web application on path / from war /example/path/to/server-5.64-96.0-jetty-console.war
