...
::
    ...
    # Must return *lookup_service_5.57-90.0.tar.gz: OK*
...
::
    ...
    tar -pxvzf lookup_service_5.57-90.0.tar.gz
...
::
    ...
    cd lookup_service_5.57-90.0
    java -Xmx8000m -jar server-5.57-90.0-jetty-console.war
...
::
    ...
    cd lookup_service_5.57-90.0
    java -Xmx8000m -jar server-5.57-90.0-jetty-console.war  [--option=value] [--option=value]

    # Example command:
    # java -Xmx8000m -jar server-5.57-90.0-jetty-console.war --headless --port 8080
...
::
    ...
    $ java -Xmx8000m -jar server-5.57-90.0-jetty-console.war
    10242 [Thread-2] INFO org.simplericity.jettyconsole.DefaultJettyManager - Added web application on path / from war /example/path/to/server-5.57-90.0-jetty-console.war
