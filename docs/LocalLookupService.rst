...
Version 5.67-99.0 of the lookup service is only compatible with version
5.67-99.0 of InterProScan. Instructions below are for installing the
...
(Direct link:
https://ftp.ebi.ac.uk/pub/software/unix/iprscan/5/5.67-99.0/lookup_service_5.67-99.0.tar.gz)
