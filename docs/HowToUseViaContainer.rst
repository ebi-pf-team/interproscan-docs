...
For the latest InterProScan release (5.76-107.0), data can be downloaded with the following command:
...
The data will be extracted to interproscan-5.76-107.0/data.
